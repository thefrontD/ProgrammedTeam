...
{
    UE_LOG(GPC, Log, TEXT("%i"), Data);
}

void Logger::Log(float const& Data)
{
    UE_LOG(GPC, Log, TEXT("%f"), Data);
}

void Logger::Log(FString const& Data)
{
    UE_LOG(GPC, Log, TEXT("%s"), *Data);
}

void Logger::Log(FVector const& Data)
{
    UE_LOG(GPC, Log, TEXT("%s"), *Data.ToString());
}
...
{
    UE_LOG(GPC, Log, TEXT("%s"), *Data->GetFName().ToString());
}
